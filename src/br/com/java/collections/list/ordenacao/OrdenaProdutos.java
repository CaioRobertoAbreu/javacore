package br.com.java.collections.list.ordenacao;
...
public class OrdenaProdutos {
	...
	public static void main(String[] args) {
		Produto produto = new Produto(312, "Monitor Samsung 23", 699., 4);
		Produto produto2 = new Produto(521, "Mouse Lenovo", 59., 6);
		Produto produto3 = new Produto(442, "Impressora HP ", 499., 9);
		Produto produto4 = new Produto(523, "Notebook Asus X510UR", 2699., 2);
